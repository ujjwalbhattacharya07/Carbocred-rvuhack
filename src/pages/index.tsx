...
const Home: NextPage = () => {
  return (
    <>
      ...
      <main className="px-0 mx-auto bg-gradient-to-r from-[#00004D] to-[#ADD86] dark:from-[#00004D] dark:to-[#008000]">
        <div className="md:text-left min-h-screen flex justify-center flex-row">
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-green dark:text-green sm:text-5xl md:text-6xl">
              <span className="block text-white xl:inline dark:text-white">
                Welcome to
              </span>
